...
function SizeSelector({
  sizeType, allSizes, onChange, selectedSize, unavailableSizes, sizeChartUrl,
}) {
...
function CartSection({ onAddToCart, canAddToCart }) {
  return html`<div class="sidebar-section cart">
          ...
          <p class="secondary-action favorites"><${Icon} name="heart" />ADD TO FAVORITES</p>
          <p class="secondary-action email"><${Icon} name="envelope" />EMAIL</p>
          <p><a href="/customer-service help">Need Help?</a></p></div>
      </div>`;
}
...
export default class ProductDetailsSidebar extends Component {
  productFromProps() {
    ...
    const sizeChart = props.product.attributes.find((attribute) => attribute.name === 'fit_guide');
